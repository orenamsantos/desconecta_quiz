...
// ─── STEPS: removidos 8 (rotina), 10 (qtd filhos), 14 (quem responde) ───────
// Renumerados internamente mas mantendo slugs originais
const PHASES = [
  { id: 1, label: "SITUACIÓN",     steps: [1,2,3,4] },
  { id: 2, label: "COMPORTAMIENTO",steps: [5,6,7,8] },
  { id: 3, label: "FAMILIA",       steps: [9,10,11] },
  { id: 4, label: "TU PLAN",       steps: [12,13,14,15] },
];
...
const STEPS = [
  ...
  {id:1,phase:1,type:"single",slug:"age",
    ...
    options:[{value:"2-3",label:"2–3 años",icon:"👶"},{value:"4-5",label:"4–5 años",icon:"🧒"},{value:"6-7",label:"6–7 años",icon:"👦"},{value:"8-9",label:"8–9 años",icon:"🧑"},{value:"10-12",label:"10–12 años",icon:"👧"}]},
  {id:2,phase:1,type:"single",slug:"screenTime",
    headline:"¿Cuántas horas al día pasa frente a una pantalla?",
    micro:"Sé honesto. No te voy a juzgar. (La mayoría de los padres subestima este número.)",
    options:[{value:"less-1h",label:"Menos de 1 hora",icon:"🟢"},{value:"1-2h",label:"1 a 2 horas",icon:"🟡"},{value:"2-4h",label:"2 a 4 horas",icon:"🟠"},{value:"4-6h",label:"4 a 6 horas",icon:"🔴"},{value:"6h+",label:"Más de 6 horas",icon:"⛔"},{value:"unknown",label:"No estoy seguro",icon:"🤷"}]},
  {id:3,phase:1,type:"multi",slug:"criticalMoments",minSelect:1,
    headline:"¿En qué momento la pantalla es IMPOSIBLE de quitar?",
    micro:"Selecciona todos los que apliquen",
    options:[{value:"morning",label:"Al despertar",icon:"🌅"},{value:"meals",label:"Durante las comidas",icon:"🍽️"},{value:"car",label:"En el auto",icon:"🚗"},{value:"bored",label:"Cuando se aburre",icon:"😤"},{value:"tantrum",label:"Cuando hace berrinche",icon:"😭"},{value:"bedtime",label:"Antes de dormir",icon:"🌙"},{value:"chores",label:"Mientras hago tareas del hogar",icon:"🏠"},{value:"work",label:"Mientras trabajo",icon:"💼"}]},
  {id:4,phase:1,type:"single",slug:"reaction",
    headline:"¿Qué pasa cuando intentas quitarle la pantalla?",
    micro:"Sé brutalmente honesto. Esta respuesta cambia tu plan por completo.",
    options:[{value:"cries",label:"Llora y hace berrinche",icon:"😢"},{value:"aggressive",label:"Se pone agresivo o grita",icon:"😡"},{value:"apathetic",label:"Se queda sin hacer nada",icon:"😶"},{value:"asks-again",label:"Acepta, pero vuelve a pedir",icon:"🔄"},{value:"accepts",label:"La acepta bien",icon:"😊"}]},
  // FASE 2
  {id:5,phase:2,type:"multi",slug:"triedMethods",minSelect:1,
    headline:"¿Qué has intentado hasta ahora para reducir las pantallas?",
    micro:"Todo lo que hayas probado cuenta",
    options:[{value:"cold-turkey",label:"Quitar todo de golpe",icon:"🚫"},{value:"schedules",label:"Poner horarios fijos",icon:"⏰"},{value:"parental-control",label:"Apps de control parental",icon:"📱"},{value:"alternatives",label:"Ofrecer alternativas",icon:"🎨"},{value:"talking",label:"Hablar y explicar",icon:"🗣️"},{value:"nothing",label:"Nada todavía",icon:"🤷"}]},
  {id:6,phase:2,type:"multi",slug:"contentType",minSelect:1,
    headline:"¿Qué tipo de contenido consume más?",
    micro:"Cada tipo estimula el cerebro de forma diferente. Esto define la intensidad de tu plan.",
    options:[{value:"cartoons",label:"Series y dibujos animados",icon:"📺"},{value:"games",label:"Videojuegos",icon:"🎮"},{value:"short-videos",label:"Videos cortos (YouTube/TikTok)",icon:"📱"},{value:"music",label:"Videos musicales / slime",icon:"🎵"},{value:"educational",label:"Apps educativas",icon:"📚"},{value:"gameplay",label:"Ver a otros jugar (gameplay)",icon:"🤳"}]},
  {id:7,phase:2,type:"single",slug:"biggestChallenge",
    headline:"Si tuvieras que elegir UNA cosa… ¿cuál es tu mayor obstáculo?",
    micro:"La respuesta más dolorosa suele ser la más verdadera.",
    options:[{value:"no-time",label:"No tengo tiempo para entretenerlo",icon:"⏰"},{value:"no-ideas",label:"No sé qué ofrecerle en su lugar",icon:"💡"},{value:"tantrums",label:"La pelea no vale la pena",icon:"😤"},{value:"partner",label:"Mi pareja no colabora",icon:"👫"},{value:"other-adults",label:"Otros adultos le dan pantalla",icon:"👨‍👩‍👧"},{value:"myself",label:"Yo mismo no puedo soltar mi celular",icon:"😩"}]},
  {id:8,phase:2,type:"single",slug:"motivation",
    headline:"¿Qué te hizo buscar una solución HOY?",
    micro:"No mañana. No la próxima semana. Hoy.",
    options:[{value:"development",label:"Me preocupa su desarrollo",icon:"🧠"},{value:"sleep",label:"Problemas para dormir",icon:"😴"},{value:"school",label:"Rendimiento escolar bajó",icon:"📉"},{value:"scared",label:"Vi algo que me asustó",icon:"👁️"},{value:"connection",label:"Pierdo la conexión con mi hijo",icon:"💔"},{value:"now-or-never",label:"Es ahora o nunca",icon:"⏰"}]},
  // FASE 3
  {id:9,phase:3,type:"single",slug:"space",
    headline:"¿Qué espacio tienes en casa para jugar?",
    micro:"El app sugiere actividades adaptadas a tu espacio — no a lo que te falta.",
    options:[{value:"small-apt",label:"Apartamento pequeño",icon:"🏠"},{value:"big-apt",label:"Apartamento grande o con balcón",icon:"🏢"},{value:"house-yard",label:"Casa con jardín o patio",icon:"🏡"},{value:"near-park",label:"Cerca de un parque o plaza",icon:"🏞️"}]},
  {id:10,phase:3,type:"single",slug:"budget",
    headline:"¿Cuánto puedes invertir en materiales?",
    micro:"Plastilina, pinturas, juegos de mesa… El app filtra las actividades según tu respuesta.",
    options:[{value:"zero",label:"Cero — solo lo que ya tengo",icon:"💚"},{value:"low",label:"Hasta $20 USD al mes",icon:"💛"},{value:"medium",label:"Hasta $50 USD al mes",icon:"🧡"},{value:"unlimited",label:"Sin límite definido",icon:"❤️"}]},
  {id:11,phase:3,type:"multi",slug:"alternatives",minSelect:1,
    headline:"Cuando NO tiene pantalla… ¿qué hace tu hijo?",
    micro:"Esto nos dice mucho sobre su nivel de dependencia",
    options:[{value:"draws",label:"Dibuja o pinta",icon:"🎨"},{value:"toys",label:"Juega con juguetes",icon:"🧩"},{value:"books",label:"Pide leer o que le lean",icon:"📖"},{value:"outdoor",label:"Corre y juega afuera",icon:"🏃"},{value:"bored",label:"Dice que está aburrido",icon:"😐"},{value:"clingy",label:"Se pega a mí pidiendo atención",icon:"😢"},{value:"never-off",label:"Casi nunca está sin pantalla",icon:"📵"}]},
  // FASE 4 — coleta
  {id:12,phase:4,type:"text",slug:"childName",
    headline:"¿Cómo se llama tu hijo(a)?",
    micro:"Vamos a usar su nombre para personalizar cada actividad del app",
    placeholder:"Ej: Mateo, Valentina…"},
  {id:13,phase:4,type:"text",slug:"parentName",
    headline:"¿Y cuál es TU nombre?",
    micro:"Para hablarte como lo que eres: alguien que está haciendo algo al respecto.",
    placeholder:"Tu primer nombre"},
  {id:14,phase:4,type:"email",slug:"email",
    headline:"¿Dónde te enviamos el acceso al app?",
    micro:"Recibirás tu link de acceso + 3 estrategias bonus. Gratis, en segundos.",
    placeholder:"tu@email.com"},
  {id:15,phase:4,type:"phone",slug:"whatsapp",
    headline:"¿Quieres recordatorios diarios por WhatsApp?",
    micro:"Las familias con recordatorio tienen 3x más probabilidad de completar el plan.",
...
const LOADING_MSGS = [
  "Analizando la edad y el temperamento…",
  "Calculando el nivel de dependencia…",
  "Seleccionando actividades para el app…",
  "Filtrando juegos según el espacio…",
  "Ajustando la reducción progresiva…",
  "Preparando guiones para la resistencia…",
  "Armando el calendario de 21 días…",
  "Casi listo — configurando tu app…",
];
...
const REVIEWS_PRICING = [
  ...
  { id: "rv3", text: "Soy abuela. Criaba a mis nietos con mucha pantalla porque no sabía qué más hacer. Las actividades del app son tan fáciles que hasta yo puedo hacerlas.", name: "Carmen L.", detail: "Abuela de Sofía (4) y Leo (6)", gender: "f", c1: "#43E97B", c2: "#38F9D7", hair: "#B0B0B0", skin: "#F0D0A8" },
];
...
const COUNTRIES = [
  ...
  {name:"Sáhara Occidental",flag:"🇪🇭",code:"+212"},
...
function Btn({children,onClick,disabled,secondary}){
  if(secondary) return <button onClick={onClick} style={{width:"100%",padding:"16px 32px",background:"var(--sf)",color:"var(--pr)",border:"2px solid var(--pr)",borderRadius:"var(--rd)",fontFamily:"var(--ft)",fontSize:16,fontWeight:800,cursor:"pointer",transition:"all .2s"}}>{children}</button>;
...
function PBar({pid, cur}){
  ...
  return <div style={{padding:"12px 20px 8px",background:"var(--bg)"}}>
    <div style={{display:"flex",gap:4,marginBottom:8}}>
      {PHASES.map(function(p){return <div key={p.id} style={{flex:1,textAlign:"center"}}>
        <div style={{height:4,borderRadius:2,marginBottom:5,background:p.id<=pid?"var(--pr)":"var(--bd)",transition:"background .3s"}}/>
        <span style={{fontSize:9,fontWeight:p.id===pid?900:600,color:p.id===pid?"var(--pr)":"var(--tl)",letterSpacing:"0.08em"}}>{p.label}</span>
      </div>})}
    </div>
    <div style={{display:"flex",alignItems:"center",justifyContent:"flex-end",gap:6}}>
      <span style={{fontSize:11,color:"var(--tl)",fontWeight:700}}>{pct}% completado</span>
    </div>
  </div>;
}
...
// ─── APP MOCKUP visual (SVG inline) ──────────────────────────────────────────
function AppMockup(){
  return <div style={{position:"relative",width:"100%",maxWidth:260,margin:"0 auto"}}>
    <svg viewBox="0 0 260 420" xmlns="http://www.w3.org/2000/svg" style={{width:"100%",filter:"drop-shadow(0 12px 32px rgba(0,0,0,.18))"}}>
      ...
      {/* header */}
      <rect x="18" y="28" width="224" height="52" rx="0" fill="#E8532E"/>
      ...
      <text x="38" y="240" fontSize="8" fill="#888" fontFamily="sans-serif">Sin materiales extra</text>
      ...
      {/* bottom nav */}
      <rect x="18" y="348" width="224" height="64" rx="0" fill="white" stroke="#E8E0D8" strokeWidth="0.5"/>
      <text x="60" y="372" textAnchor="middle" fontSize="18" fontFamily="sans-serif">🏠</text>
      <text x="60" y="385" textAnchor="middle" fontSize="7" fill="#E8532E" fontWeight="700" fontFamily="sans-serif">Hoy</text>
      <text x="130" y="372" textAnchor="middle" fontSize="18" fontFamily="sans-serif">📅</text>
      <text x="130" y="385" textAnchor="middle" fontSize="7" fill="#888" fontFamily="sans-serif">Plan</text>
      <text x="200" y="372" textAnchor="middle" fontSize="18" fontFamily="sans-serif">👤</text>
      <text x="200" y="385" textAnchor="middle" fontSize="7" fill="#888" fontFamily="sans-serif">Perfil</text>
    </svg>
  </div>;
}
...
export default function App(){
  ...
  var goN=function(){
    ...
    if(cur===7&&!tn){setTn(2);top2();return}
  ...
  if(scr==="start"){
    return <div ref={rf} style={SH}><style>{GCSS}</style>
      <div style={{padding:"40px 24px 32px",textAlign:"center",animation:"fi .45s ease both"}}>
        <div style={{fontSize:28,fontWeight:900,letterSpacing:"-0.03em",color:"var(--pr)",marginBottom:4}}>DESCONECTA</div>
        <div style={{fontSize:11,color:"var(--tl)",letterSpacing:"0.15em",fontWeight:600,marginBottom:8}}>EL APP DE 21 DÍAS</div>
        <div style={{display:"inline-flex",alignItems:"center",gap:6,background:"var(--sl)",border:"1px solid #B8DFC9",borderRadius:20,padding:"5px 14px",marginBottom:32}}>
          <span style={{fontSize:11,fontWeight:800,color:"var(--sc)"}}>📱 Disponible en Android e iPhone</span>
        </div>
        <h1 style={{fontSize:26,fontWeight:900,lineHeight:1.25,marginBottom:8}}>El app que ayuda a tu hijo a…</h1>
        ...
        <div style={{width:50,height:3,background:"var(--pr)",borderRadius:2,margin:"20px auto"}}/>
        <p style={{fontSize:15,color:"var(--tm)",marginBottom:8,lineHeight:1.6}}>Responde unas preguntas rápidas y recibe un plan de actividades personalizado para la edad y el temperamento de tu hijo.</p>
        <p style={{fontSize:15,fontWeight:700,marginBottom:28}}>Es gratis. Toma 3 minutos. Y puede cambiar todo.</p>
        <div style={{marginBottom:28}}>
          <AppMockup/>
        </div>
        <Btn onClick={function(){setScr("quiz")}}>QUIERO MI PLAN PERSONALIZADO</Btn>
        <p style={{fontSize:13,color:"var(--tl)",marginTop:16,fontWeight:600}}>Más de 12,000 familias ya usan el app</p>
  ...
  // ═══════ QUIZ ═══════
  if(scr==="quiz"){
    if(tn){var t=TR[tn];return <div ref={rf} style={SH}><style>{GCSS}</style><PBar pid={pid} cur={cur}/>
    ...
    if(stp&&stp.slug==="email"&&ud.childName)hl="¡"+ud.childName+" ya tiene su plan listo! ¿A dónde enviamos el acceso al app?";
    var an2=ad==="in"?"si .3s ease both":"so .25s ease both";

    var selC=ud.country||"México";
    var cObj=COUNTRIES.find(function(c){return c.name===selC})||COUNTRIES[15];
    ...
    return <div ref={rf} style={SH}><style>{GCSS}</style><PBar pid={pid} cur={cur}/>
      <div key={cur} style={{padding:"24px 20px 120px",animation:an2}}>
        <div style={{fontSize:12,color:"var(--tl)",fontWeight:700,marginBottom:8,letterSpacing:"0.05em"}}>{"PREGUNTA "+cur+" DE "+TOTAL_STEPS}</div>
        ...
        {stp&&stp.type==="email"?<div style={{marginBottom:24}}>
          <div style={{display:"flex",alignItems:"center",gap:8,background:"var(--sl)",border:"1px solid #B8DFC9",borderRadius:"var(--rd)",padding:"10px 14px",marginBottom:12}}>
            <span style={{fontSize:18}}>📱</span>
            <span style={{fontSize:12,fontWeight:700,color:"var(--sc)",lineHeight:1.4}}>Você receberá acesso imediato ao app Desconecta no seu email</span>
          </div>
          ...
          <button onClick={function(){setAd("out");setTimeout(function(){setCur(15);setTn(null);setAd("in");top2()},250)}} style={{background:"none",border:"none",fontSize:13,color:"var(--tl)",cursor:"pointer",fontFamily:"var(--ft)",fontWeight:600,padding:"10px 0 0",textDecoration:"underline",display:"block",width:"100%",textAlign:"center"}}>No tengo email — prefiero recibir por WhatsApp →</button>
        </div>:null}

        {stp&&stp.type==="phone"?<div style={{marginBottom:24}}>
          <div style={{display:"flex",alignItems:"center",gap:8,background:"var(--sl)",border:"1px solid #B8DFC9",borderRadius:"var(--rd)",padding:"10px 14px",marginBottom:12}}>
            <span style={{fontSize:18}}>💬</span>
            <span style={{fontSize:12,fontWeight:700,color:"var(--sc)",lineHeight:1.4}}>Recibirás recordatorios diarios del app + tu link de acceso por WhatsApp</span>
          </div>
          <div style={{display:"flex",gap:8,marginBottom:8}}>
            <div style={{position:"relative"}}>
              <button onClick={function(){setCountryOpen(!countryOpen)}} style={{display:"flex",alignItems:"center",gap:6,padding:"18px 12px",fontSize:22,background:"var(--sf)",border:"2px solid var(--bd)",borderRadius:"var(--rd)",cursor:"pointer",fontFamily:"var(--ft)",whiteSpace:"nowrap",height:"100%"}}>
                <span>{cObj.flag}</span>
                <span style={{fontSize:13,fontWeight:700,color:"var(--tx)"}}>{cObj.code}</span>
                <span style={{fontSize:10,color:"var(--tl)"}}>▼</span>
              </button>
              {countryOpen&&<div style={{position:"absolute",top:"100%",left:0,zIndex:999,background:"var(--sf)",border:"2px solid var(--bd)",borderRadius:"var(--rd)",boxShadow:"0 8px 32px rgba(0,0,0,.12)",maxHeight:260,overflowY:"auto",minWidth:220,marginTop:4}}>
                {COUNTRIES.map(function(c){return <button key={c.name} onClick={function(){setUd(function(p){var n={};for(var k in p)n[k]=p[k];n.country=c.name;n.whatsapp=c.code+" "+phoneNum;return n});setCountryOpen(false)}} style={{display:"flex",alignItems:"center",gap:10,width:"100%",padding:"12px 14px",background:c.name===selC?"var(--pl)":"none",border:"none",borderBottom:"1px solid var(--bd)",cursor:"pointer",fontFamily:"var(--ft)",textAlign:"left"}}>
                  <span style={{fontSize:20}}>{c.flag}</span>
                  <span style={{fontSize:13,fontWeight:600,color:"var(--tx)",flex:1}}>{c.name}</span>
                  <span style={{fontSize:12,color:"var(--tl)",fontWeight:700}}>{c.code}</span>
                </button>})}
              </div>}
            </div>
            <input type="tel" placeholder="(000) 000-0000" value={phoneNum} onChange={function(e){var v=e.target.value;setUd(function(p){var n={};for(var k in p)n[k]=p[k];n.whatsapp=cObj.code+" "+v;return n})}} style={Object.assign({},INP,{flex:1})}/>
          </div>
          {countryOpen&&<div onClick={function(){setCountryOpen(false)}} style={{position:"fixed",inset:0,zIndex:998}}/>}
          <button onClick={function(){setAd("out");setTimeout(function(){setCur(14);setTn(null);setAd("in");top2()},250)}} style={{background:"none",border:"none",fontSize:13,color:"var(--tl)",cursor:"pointer",fontFamily:"var(--ft)",fontWeight:600,padding:"10px 0 0",textDecoration:"underline",display:"block",width:"100%",textAlign:"center"}}>← Volver — prefiero recibir por email</button>
        </div>:null}
        ...
        <div style={{position:"fixed",bottom:0,left:"50%",transform:"translateX(-50%)",width:"100%",maxWidth:480,padding:"12px 20px 20px",background:"linear-gradient(transparent, #FFFBF5 20%)"}}>
          ...
          :<Btn onClick={goN} disabled={!ok()}>{stp&&stp.slug==="email"?"ACCEDER AL APP AHORA →":"CONTINUAR →"}</Btn>}
        </div>
      </div>
    </div>;
  }
  ...
  if(scr==="loading"){
    return <div ref={rf} style={SH}><style>{GCSS}</style>
      <div style={{padding:"80px 28px",textAlign:"center",animation:"fi .6s ease both"}}>
        ...
        <h2 style={{fontSize:22,fontWeight:900,marginBottom:8,lineHeight:1.3}}>{"Configurando el app de "+cn+"…"}</h2>
        <p style={{fontSize:14,color:"var(--tm)",marginBottom:40}}>Estamos personalizando cada actividad. Vale la pena esperar.</p>
  ...
  if(scr==="result"){
    ...
    var bens=[
      {ic:"🧠",ti:"Atención restaurada",de:cn+" va a recuperar la capacidad de concentrarse sin pantalla en menos de 7 días."},
      {ic:"💛",ti:"Conexión fortalecida",de:"Momentos reales juntos. Sin pantalla compitiendo por la atención."},
      {ic:"🌙",ti:"Sueño reparado",de:"Reducir estímulos antes de dormir mejora el sueño notablemente desde la primera semana."},
      {ic:"🎨",ti:"Creatividad desbloqueada",de:cn+" va a redescubrir el placer de jugar, crear e imaginar — sin necesitar una pantalla."},
    ];
    var days=["Diagnóstico: mapear los momentos críticos de pantalla","Actividad sustituta #1 (personalizada para "+cn+")","Ritual de transición — el truco que evita berrinches","Reducir 30 min en el momento más difícil","Día de juego guiado (con guión listo para ti)","Revisión + celebrar las primeras victorias","Preparar la Semana 2 del app"];

    return <div ref={rf} style={SH}><style>{GCSS}</style>
      <div style={{animation:"fi .6s ease both"}}>
        {/* Hero resultado */}
        <div style={{background:"linear-gradient(135deg,var(--pl),#FFF5E6)",padding:"36px 24px 28px",textAlign:"center"}}>
          <div style={{fontSize:48,marginBottom:12}}>🎯</div>
          <h1 style={{fontSize:24,fontWeight:900,lineHeight:1.25,marginBottom:8}}>{"El plan de "+cn+" está listo"+(pn?", "+pn:"")+"."}</h1>
          <p style={{fontSize:15,color:"var(--tm)",lineHeight:1.5,marginBottom:16}}>Basado en tus respuestas, el app va a guiarte con un programa de <strong>Sustitución Progresiva</strong> personalizado.</p>
          <div style={{display:"inline-flex",alignItems:"center",gap:6,background:"var(--sl)",border:"1px solid #B8DFC9",borderRadius:20,padding:"6px 16px"}}>
            <span style={{fontSize:12,fontWeight:800,color:"var(--sc)"}}>📱 Acceso imediato via app • Android e iPhone</span>
          </div>
        </div>
        ...
        <div style={{padding:"24px 20px 32px"}}>
          ...
          <div style={{display:"grid",gridTemplateColumns:"1fr 1fr",gap:10,marginBottom:28}}>
            {[
              {ic:"🧒",la:cn,su:ans.age?(ans.age+" años"):""},
              {ic:"📱",la:screenT,su:"por día"},
              {ic:"🎯",la:"Motivación",su:motiv},
              {ic:"📅",la:"21 días",su:"en el app"},
            ].map(function(c,i){
          ...
          {/* Mockup do app */}
          <div style={{marginBottom:28}}>
            <p style={{fontSize:13,fontWeight:700,color:"var(--tl)",textAlign:"center",marginBottom:12,letterSpacing:"0.05em"}}>ESTO ES LO QUE VERÁS EN EL APP</p>
            <AppMockup/>
          </div>

          {/* Benefícios */}
          <h3 style={{fontSize:18,fontWeight:900,marginBottom:16,textAlign:"center"}}>Lo que el app va a hacer por tu familia:</h3>
          ...
          {/* Preview semana 1 */}
          <h3 style={{fontSize:18,fontWeight:900,marginBottom:16}}>Vista previa — Semana 1 en el app:</h3>
          ...
          {[2,3].map(function(w){return <div key={w} style={{background:"var(--sf)",border:"1px solid var(--bd)",borderRadius:"var(--rd)",padding:"24px 16px",textAlign:"center",marginBottom:10}}>
            <span style={{fontSize:24,display:"block",marginBottom:6}}>🔒</span>
            <span style={{fontSize:13,fontWeight:700,color:"var(--tm)"}}>{"Semana "+w+" — Desbloqueada en el app completo"}</span>
          </div>})}

          {/* CTA pré-pricing */}
          <div style={{marginTop:28,background:"linear-gradient(135deg,#FFF0EB,#FFF5E6)",border:"2px solid var(--pr)",borderRadius:"var(--rd)",padding:"24px 20px",textAlign:"center",marginBottom:20}}>
            <p style={{fontSize:13,color:"var(--tl)",fontWeight:600,marginBottom:6}}>🔥 4,837 familias empezaron el desafío este mes</p>
            <p style={{fontSize:16,fontWeight:900,marginBottom:4,color:"var(--tx)"}}>Accede al app por apenas</p>
            <div style={{display:"flex",alignItems:"baseline",justifyContent:"center",gap:8,marginBottom:16}}>
              <span style={{fontSize:16,color:"var(--tl)",textDecoration:"line-through",fontWeight:600}}>$37</span>
              <span style={{fontSize:44,fontWeight:900,color:"var(--pr)",lineHeight:1}}>$7</span>
              <span style={{fontSize:14,color:"var(--tl)"}}>USD</span>
            </div>
            <Btn onClick={function(){setScr("pricing");top2()}}>QUIERO ACCEDER AL APP →</Btn>
            <p style={{fontSize:11,color:"var(--tl)",marginTop:10}}>Pago único • Acceso de por vida • Android e iPhone</p>
          </div>
        </div>
      </div>
    </div>;
  ...
  if(scr==="pricing"){
    var pls=[
      {id:"basic",nm:"Acceso Inicial",pr:7,op:37,bd:"",
        ft:[
          "App Desconecta (Android e iPhone)",
          "Plan de 21 días personalizado",
          "Checklist diario de actividades",
          "7 actividades por edad de tu hijo",
        ]},
      {id:"complete",nm:"Transformación Completa",pr:17,op:67,bd:"MÁS ELEGIDO",
        ft:[
          "Todo lo del Acceso Inicial",
          "50+ actividades por edad",
          "Guiones listos para berrinches",
          "Rutina nocturna sin pantallas",
          "Guía: Cómo hablar con los abuelos",
          "Notificaciones inteligentes en el app",
        ]},
      {id:"family",nm:"Familia Desconectada",pr:27,op:97,bd:"MEJOR VALOR",
        ft:[
          "Todo lo de Transformación Completa",
          "Hasta 3 perfiles de hijos en el app",
          "Comunidad privada de padres",
          "Sesión en vivo mensual",
          "Actividades especiales por temporada",
          "Soporte prioritario por WhatsApp",
        ]},
    ];
    var fqs=[
      {q:"¿En qué dispositivos funciona el app?",a:"Desconecta funciona en Android (5.0+) e iPhone (iOS 13+). También puedes acceder desde el navegador de tu computadora."},
      {q:"¿Cuándo recibo acceso al app?",a:"Inmediatamente después del pago. Te enviamos el link de descarga por email y por WhatsApp (si lo proporcionaste)."},
      {q:"¿Funciona para cualquier edad?",a:"Sí. El app se adapta a la edad que indicaste (2-12 años). Las actividades y guiones cambian según la edad."},
      {q:"¿Y si mi hijo hace mucho berrinche?",a:"El plan incluye guiones listos para cada tipo de reacción. La Sustitución Progresiva reduce gradualmente — NO quita todo de golpe."},
      {q:"¿Necesito mucho tiempo libre?",a:"No. Diseñado para padres que trabajan. La mayoría de actividades toman 10-15 minutos y no requieren materiales especiales."},
      {q:"¿Y si no me gusta?",a:"Garantía incondicional de 7 días. Te devolvemos el 100% sin preguntas. El riesgo es completamente nuestro."},
    ];

    var ctaTxt = sp==="basic" ? "ACCEDER AL APP POR $7 →" : sp==="complete" ? "QUIERO LA TRANSFORMACIÓN COMPLETA — $17 →" : "QUIERO EL PLAN FAMILIAR — $27 →";

    return <div ref={rf} style={SH}><style>{GCSS}</style>
      <div style={{animation:"fi .5s ease both"}}>
        {/* Urgency bar */}
        <div style={{background:"linear-gradient(90deg,var(--dn),#FF6B35)",color:"#fff",padding:"12px 16px",textAlign:"center",fontSize:14,fontWeight:800}}>
          {"🔥 OFERTA ESPECIAL — Expira en "+fmt(cd)}
        </div>

        <div style={{padding:"28px 20px 40px"}}>
          {/* Headline personalizado */}
          <h2 style={{fontSize:22,fontWeight:900,textAlign:"center",marginBottom:6,lineHeight:1.3}}>
            {(pn?pn+", elige":"Elige")+" tu acceso al app"}
          </h2>
          <p style={{fontSize:14,color:"var(--tm)",textAlign:"center",marginBottom:8}}>
            Acesso imediato ao app • Android e iPhone
          </p>
          <p style={{fontSize:13,color:"var(--tl)",textAlign:"center",marginBottom:24,fontWeight:600}}>
            📱 Link de descarga en menos de 2 minutos
          </p>
              ...
              return <button key={pl.id} onClick={function(){setSp(pl.id)}} style={{width:"100%",textAlign:"left",cursor:"pointer",background:is2?"var(--pl)":"var(--sf)",border:is2?"2px solid var(--pr)":"2px solid var(--bd)",borderRadius:"var(--rd)",padding:"20px 18px",position:"relative",fontFamily:"var(--ft)",transform:is2?"scale(1.02)":"none",transition:"all .2s",boxShadow:is2?"0 4px 20px rgba(232,83,46,.15)":"none"}}>
                ...
                <div style={{display:"flex",justifyContent:"space-between",alignItems:"center",marginBottom:12}}>
                  ...
                  <div style={{textAlign:"right"}}>
                    <span style={{fontSize:13,color:"var(--tl)",textDecoration:"line-through",marginRight:6}}>{"$"+pl.op}</span>
          ...
          {/* CTA principal */}
          <Btn onClick={function(){alert("Checkout — integra tu pasarela de pago aquí")}}>{ctaTxt}</Btn>
          <div style={{display:"flex",justifyContent:"center",gap:16,marginTop:12,fontSize:12,color:"var(--tl)"}}>
            <span>💳 Tarjeta</span><span>📲 PayPal</span><span>🍎 Apple Pay</span>
          </div>

          {/* Garantia — logo abaixo do botão */}
          <div style={{marginTop:20,background:"var(--sl)",border:"1px solid #B8DFC9",borderRadius:"var(--rd)",padding:20,textAlign:"center"}}>
          ...
          <div style={{textAlign:"center"}}>
            ...
            <Btn onClick={function(){alert("Checkout — integra tu pasarela de pago aquí")}}>{ctaTxt}</Btn>
            <p style={{fontSize:11,color:"var(--tl)",marginTop:12}}>Pago único • Sin suscripciones • Acceso de por vida • Android e iPhone</p>
          </div>
        </div>
      </div>
    </div>;
